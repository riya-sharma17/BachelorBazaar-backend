...
router.post("/email-login", (0, validation_1.validateRequest)(user_validation_1.emailLoginValidation), user_controller_1.emailLogin);
...
router.post("/verify-otp", (0, validation_1.validateRequest)(user_validation_1.verifyOtpValidation), user_controller_1.verifyOtp);
