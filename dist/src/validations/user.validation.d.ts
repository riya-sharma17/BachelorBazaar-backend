...
export declare const emailLoginValidation: Joi.ObjectSchema<any>;
export declare const googleLoginValidation: Joi.ObjectSchema<any>;
...
export declare const listUsersValidation: Joi.ObjectSchema<any>;
